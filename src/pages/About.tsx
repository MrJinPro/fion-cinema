          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  FiOn Cinema — это современный веб-каталог фильмов и сериалов, который предоставляет 
                ...
                <p>
                  FiOn создан как некоммерческий образовательный проект и предназначен исключительно 
